...
char_names = [
    "Thalwen", "Marjorielle", "Drevik", "Nimaé", "Corvinus", "Liora", "Fenric", "Ysilde", "Brambletuck", "Kaelen",
    "Odra the Quiet", "Sir Pindleworth", "Ériska", "Jorran", "Velka", "Maelis of the Dusk", "Tarnik", "Belladora",
    "Rooke", "Nemri", "Azgarn", "Fiolla", "Wendilynn", "Quorran", "Ephraim the Slightly Lost", "Zaliara", "Grimble",
    "Ansel of Greenmere", "Nehari", "Torvik Ashhand"
]

char_adjectives = [
    "Sleepy", "Bloody", "Mysterious", "Sulky", "Radiant", "Slimy", "Cursed", "Chatty", "Hungry", "Enraged",
    "Grumpy", "Shadowed", "Proud", "Damp", "Shimmering", "Rusty", "Toothless", "Wailing", "Elegant", "Giggly",
    "Rotten", "Burning", "Polite", "Ashen", "Sticky", "Mourning", "Sneaky", "Draconic", "Twinkling", "Wrinkled",
    "Slumbering", "Sour", "Gleeful", "Venomous", "Ragged", "Unblinking", "Sizzling", "Confused", "Hollow", "Wicked",
    "Blubbering", "Shy", "Grinning", "Withered", "Ancient", "Yawning", "Echoing", "Frail", "Melancholy", "Spiky"
]
